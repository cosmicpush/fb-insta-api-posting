...
def _build_prompt() -> str:
    return (
        "You are a social media copywriter for Instagram and Facebook. "
...
def generate_caption(config: ClaudeConfig, image_url: str) -> str:
    return _generate_caption(config, image_url, "image/png")


def generate_caption_with_type(
    config: ClaudeConfig, image_url: str, media_type: str
) -> str:
    return _generate_caption(config, image_url, media_type)


def _generate_caption(config: ClaudeConfig, image_url: str, media_type: str) -> str:
